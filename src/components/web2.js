...
export default function Web2(props) {
    ...
    return (
        <div className="sub-2">
            <top className="sub-head"><p className="sub-heading">Web 2.0 Domains<k style={{ fontSize: 20, color: 'grey' }}> show : </k><k className="this">This month ↓</k></p><div style={{fontSize:'x-large',display: 'flex',flexDirection:'row',width:'30%',alignItems:'center'}}><b>Manage web 2.0</b> <ArrowCircleRightOutlinedIcon style={{height:'60%',width:'30%',color:'blue'}}/></div></top>
